...
- **Offline Plotting of CAN Dumps**: Dynamically rebuilds plot points from the existing/imported log traffic when a user toggles signal plotting, permitting offline plotting and analysis of imported CAN dumps without requiring live transmission. Increased plotting capacity to 1000 items.
